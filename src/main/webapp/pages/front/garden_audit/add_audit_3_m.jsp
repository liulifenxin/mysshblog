	...
	<head>
		...
		$(function(){
			$("#next_step").click(function(){
				alert("hello");
				window.open("${pageContext.request.contextPath}/upfiles/downlingInformation201802.xlsx"); 
			});
		});
		</script>
	</head>
		...
		<div class="wrap">
			...
			<div class="table t_down" style="display: none;">
		...
		<div id="step" class="clear">
			...
			<div id="next_step" class="fl">生成审计结果</div>
		</div>
		<!--step end-->
