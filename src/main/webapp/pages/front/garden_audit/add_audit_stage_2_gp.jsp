...
<script>	
	...
	function upload(e,index) {
		...
		$('#upload').change( function() {					
			...
			$.ajax({
				type : 'post',
				url : "${pageContext.request.contextPath}/front/garden_audit/add_audit_stage3_gp",
				data : formData,
				cache : false,
				processData : false,
				contentType : false,
	...
	<div class="wrap" style="height:900px">
		...
		<div id="content">
			...
			<!-- <script>
				...
				$(".up").click(function(){
					sIndex = $(this).index();
					alert("1111111111 = " + sIndex);
				});
			</script> -->
			
			<!--上传成功-->
			<img id="success" style="display: none;" src="${pageContext.request.contextPath}/audit-asset/img/success.png" />
		</div>
		<!--content end-->
	</div>
	<!--wrap end-->
...
<% String id =  (String)request.getAttribute("projectId"); %>
	...
	$("#next_step_a").on("click",function(){
        ...
        window.location.href="${pageContext.request.contextPath}/front/garden_audit/add_audit_4_gp?projectId=${ project.id}";
